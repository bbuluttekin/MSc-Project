...
\end{itemize}
The intuition behind choosing these objectives instead of attempting to build novel architecture from scratch is the process of choosing architecture has a very large search space and requires a lot of iteration and experimentation. Due to the limited time frame of this project attempting new architecture would not be feasible.
