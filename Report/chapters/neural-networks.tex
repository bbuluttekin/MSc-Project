...
Due to iterative nature of the machine learning it is vital that the experimentation for the task will run in sufficiently quick that the improvement the model can be identified quickly and progressed to further stages. 
However, standard ANNs usually have millions of parameters that need to be updated with hundreds of thousand if not millions of training examples. 
...
Trainig library included the fallowing attributes to overcome the challenges described earlier
