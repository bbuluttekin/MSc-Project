...
During the training of the machine learning model we utilize the training set where we can calculate training loss and performance metrics of the training data. 
