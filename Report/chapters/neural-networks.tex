...
Most machine learning algorithms utilize some sort of optimization. Main objective of the optimization algorithms is to find maximum or minimum point for the function in hand with respect to one or more variable. Task of searching minimum or maximum can be used interchangeably as finding minimum point of the function $f$ may also be found by getting maximum of inverse function of the same function ($f^{-1}$).
