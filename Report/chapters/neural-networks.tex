...
For the definition of Convolutional Neural Networks (CNNs), I used the definition from Deep Learning book~\cite{deeplearningbook} in the proposal of this project that I believe summarize the concept very well. 
